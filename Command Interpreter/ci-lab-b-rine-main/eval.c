            ...
            switch (nptr->tok) {
                ...
                case TOK_QUESTION:
                    if (nptr->children[1]->type == BOOL_TYPE 
                        && nptr->children[2]->type == BOOL_TYPE) {
                        nptr->type = BOOL_TYPE;
                    } else if (nptr->children[1]->type == INT_TYPE 
                        && nptr->children[2]->type == INT_TYPE) {
                        nptr->type = INT_TYPE;
                    } else if (nptr->children[1]->type == STRING_TYPE
                        && nptr->children[2]->type == STRING_TYPE) {
                        nptr->type = STRING_TYPE;
                    } else {
                        handle_error(ERR_TYPE);
                    }
                ...
                case TOK_NOT:
                    ...
                    break;
                case TOK_ASSIGN:
                    if (nptr->children[0]->type == ID_TYPE) {
        ...
        case NT_INTERNAL:
                ...
                switch (nptr->tok) {
                    case TOK_UMINUS:
                        if (nptr->children[0]->type == INT_TYPE) {
                            ...
                            char *revString = strrev(nptr->children[0]->val.sval);
                            nptr->val.sval = revString;
                        }                    
                        break;
                    case TOK_NOT:
            ...
            if (is_binop(nptr->tok)) {
                switch (nptr->tok) {
                    case TOK_PLUS:
                        if (nptr->children[0]->type == INT_TYPE) {
                            nptr->val.ival = nptr->children[0]->val.ival 
                                + nptr->children[1]->val.ival;
                        } else if (nptr->children[0]->type == STRING_TYPE) {
                            if (nptr->children[1] < 0) {
                    ...
                    case TOK_TIMES:
                        if (nptr->children[0]->type == INT_TYPE) {
                            ...
                            for (int i = 0; i < times; i++) {
                                nptr->val.sval = strcat(nptr->val.sval, 
                    ...
                    case TOK_LT:
                        if (nptr->children[0]->type == INT_TYPE) {
                            nptr->val.bval = nptr->children[0]->val.ival 
                                < nptr->children[1]->val.ival;
                        } else if (nptr->children[0]->type == STRING_TYPE) {
            ...
            if (nptr->tok == TOK_QUESTION) {
                ...
                if (nptr->children[0]->val.bval) {
                    ...
                    if (nptr->children[1]->type == INT_TYPE) {
                        ...
                        nptr->val.sval = strcpy(nptr->val.sval, nptr->children[1]->val.sval);
                    }
                } else {
                    ...
                    if (nptr->children[2]->type == INT_TYPE) {
                        ...
                        nptr->val.sval = strcpy(nptr->val.sval, nptr->children[2]->val.sval);
                    }
                }
            }
